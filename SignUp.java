...
public class SignUp extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(51, 51, 255)), "SignUp", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Tahoma", 1, 18), new java.awt.Color(51, 51, 255))); // NOI18N
        ...
        setSize(new java.awt.Dimension(621, 511));
...
try
{
  String sql1 = "Insert into Employee(Emp_Name, Emp_Password, Emp_Phone, Emp_Address)values(?,?,?,?)";
  pst=conn.prepareStatement(sql1);
  pst.setString(1, jTextField1.getText());
  pst.setString(2, jTextField2.getText());
  pst.setString(3, jTextField4.getText());
  pst.setString(4, jTextField5.getText()+ jTextField6.getText()+ jTextField7.getText());
  pst.execute();
